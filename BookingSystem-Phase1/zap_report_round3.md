...
| Low | Warning |  | ZAP warnings logged - see the zap.log file for details | 96    |
| Info | Informational | http://localhost:8003 | Percentage of responses with status code 2xx | 53 % |
| Info | Informational | http://localhost:8003 | Percentage of responses with status code 3xx | 39 % |
| Info | Exceeded Low | http://localhost:8003 | Percentage of responses with status code 4xx | 7 % |
