...
| Low | Warning |  | ZAP warnings logged - see the zap.log file for details | 75    |
| Info | Informational | http://localhost:8002 | Percentage of responses with status code 2xx | 46 % |
